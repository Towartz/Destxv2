...
"custom" in command ? console.log(Ft.color(`-> Loaded custom`, 'green') + Ft.color(` ${command.name}`, 'orange')) :console.log(Ft.color(`-> Loaded command`, 'orange') + Ft.color(` ${command.name}`, 'yellow'));
}
